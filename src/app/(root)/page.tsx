	...
	return (
		<>
			<ThemeProvider theme={theme}>
				...
				<div className='fixed inset-0 bg-gradient-to-b from-zinc-950 from-20% to-transparent to-30% z-40'></div>
				<div className='fixed inset-0 lg:bg-gradient-to-r from-zinc-950 to-transparent to-10%'></div>
				<div className='fixed inset-0 lg:bg-gradient-to-l from-zinc-950 to-transparent to-10%'></div>
