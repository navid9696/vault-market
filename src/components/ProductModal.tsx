			...
			<div className='h-[80dvh] w-[80dvw] flex md:gap-8 gap-2'>
				...
				<div className='md:w-1/3 w-1/2 flex flex-col items-center justify-evenly'>
					...
					<div
						...
						className='p-2 flex flex-col shadow-inset-1 text-black bg-green-700 md:hover:bg-green-700 hover:bg-green-500 md:cursor-default cursor-pointer transition-colors'>
						<p className='font-semibold text-xl'>{ratingValue}</p>
						<StyledRating
					...
					<div>
						<div className='my-4 p-4 shadow-inset-2 rounded-xl bg-gradient-to-bl from-zinc-900 via-green-300 to-zinc-900'>
							<div className='relative min-h-36 h-full min-w-32'>
								<Image
									className='hover:scale-125 object-contain transition-transform'
